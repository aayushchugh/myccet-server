...
export async function postCreateSubjectHandler(
  ...
  try {
    const {
      title,
      code,
      internal_passing_marks,
      external_passing_marks,
      internal_marks,
      external_marks,
    } = req.body;
    ...
    await createSubject({
      title: title,
      code: code,
      internal_passing_marks: internal_passing_marks,
      external_passing_marks: external_passing_marks,
...
export async function deleteSubjectHandler(
  ...
  try {
    ...
    const success = await deleteSubjectByCode(code);
